...
urlpatterns = [
    ...
    path("documentation/", TemplateView.as_view(template_name="pages/documentation.html"), name="home"),
    path("projekt/", TemplateView.as_view(template_name="pages/projekt.html"), name="home"),
    path(
        "about/",
